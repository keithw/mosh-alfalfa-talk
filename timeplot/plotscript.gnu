...
plot "sprout.usage" using 2:($5/1.e3) with lines lt 7 lw 3 title "Capacity", "skype.usage" using 2:($9/1.e3) with lines lt 1 lw 3 title "Skype", "sprout.usage" using 2:($9/1.e3) with lines lt 3 lw 3 title "Alfalfa"
...
plot "both.kd" using 1:2 with lines lt 1 lw 5, "" using 1:3 with lines lw 2 lc 3
